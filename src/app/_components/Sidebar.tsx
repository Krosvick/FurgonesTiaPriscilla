    ...
    return (
        <aside className="drawer lg:drawer-open">
            ...
            <div className="drawer-side">
                ...
                <div className="flex items-center mt-5 lg:mx-5">
                    <ul className="menu rounded-lg shadow-lg bg-gray-700 bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-60 text-gray-200 font-medium">
