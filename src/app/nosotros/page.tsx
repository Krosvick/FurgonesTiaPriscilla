...
export default function page() {
    return (
        <section className="min-w-screen flex flex-col justify-center min-h-screen items-center p-5">
            ...
            <div className="bg-white h-fit rounded-xl max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
                            ...
                            <ul role="list" className="space-y-2 sm:space-y-4">
                                <li className="flex space-x-3">
                                    ...
                                    <span className="text-sm sm:text-base text-gray-500">
                                        <span className="font-bold">Rapido y seguro</span>
                                    </span>
                                </li>
            ...
            <div className="flex flex-row w-screen overflow-x-hidden gap-6 mt-4 h-fit p-4 justify-center items-center mx-auto max-w-[85rem]">
                <div className="w-1/2 flex-grow flex-basis-0 p-6 bg-white rounded-xl">
